        ...
        <div className="flex gap-16 flex-col max-w-xl my-0">
          <h4 className="text-center">Add a new location</h4>
            <div className="w-full">
              ...
              <button className="bg-green-700 text-white rounded p-2 w-full" onClick={getCurrentLocation}>Get Current Location</button>
            </div>
            <div className="w-full">
              ...
              <button className="bg-green-700 text-white rounded p-2 w-full" onClick={handleClick}>Add a new location now</button>
            </div>
          </div>
       </div>
